...
const Nav = () => {
  return (
    ...
    <div className="grid grid-cols-2 lg:grid-cols-3  container mx-auto sticky  top-0 h-25 ">
        <div className="content-center mx-5 ">
            <img className="h-6 lg:hidden"   src="/assets/hamburger.png" />
            <img className="h-14 hidden lg:block" src="/assets/logo-text.png" />
        </div>
